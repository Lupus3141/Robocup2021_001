...
void sucheKugel() {
  Serial.println("suche jetzt nach Kugeln");
  ...
  while (foundBall == false) {
    ...
    if (readString != "") {
      Serial.println(readString);
      if (readString == "L") {
        Serial.println("habe L empfangen!!!");
        fahre(-255, 255, 10);
        fahre(0, 0, 0);
      } if (readString == "R") {
        Serial.println("habe R empfangen!!!");
        fahre(255, -255, 10);
        fahre(0, 0, 0);
      } if (readString == "V") {
        Serial.println("habe V empfangen");
        //fahre vor
        fahre(255, 255, 10);
        fahre(0, 0, 0);
        delay(100);
      } if (readString == "Z") {
        Serial.println("habe Z empfangen");
        //fahre zurueck
        fahre(-255, -255, 10);
        fahre(0, 0, 0);
        delay(100);
      } if (readString == "P") {
        Serial.println("habe P empfangen");
        //drehe dich und nehme Kugel auf
        fahre(-255, -255, 50);
        fahre(255, -255, neunzigGrad * 2);
        fahre(-255, -255, 65); //Stück zu Kugel hin
        fahre(0, 0, 0); //stoppen
        delay(100); //ausrollen lassen
        greiferRunter(); //Greifer runter -> Kugel aufnehmen
        delay(3000);
        greiferHoch();
        delay(3000);
